...
const testUsers = {
    driver: {
        email: `safidy${Date.now()}@test.com`,
        password: '123azeqsD',
        displayName: 'Safidy Conductrice',
        firstName: 'Safidy',
        lastName: 'Michelle',
        gender: 'femme',
        phone: '0612345678'
    ...
    passenger: {
        email: `ando${Date.now()}@test.com`,
        password: '123azeqsD',
        displayName: 'Ando Passagère',
        firstName: 'Ando',
        lastName: 'Andraina',
        gender: 'femme',
        phone: '0687654321'
...
const testTrip = {
    ...
    availableSeats: 2,
    distance: 6, // distance réelle approximative en km
...
const runCompleteUserFlow = async () => {
    ...
    try {
        ...
        // ✅ ÉTAPE 6 : Confirmation simple (SANS création PaymentIntent séparée)
        ...
        if (finalizeResult.success) {
            ...
            console.error('❌ Échec paiement:', finalizeResult.error);
