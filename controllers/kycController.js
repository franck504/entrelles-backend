    ...
    try {
      ...
      if (user.kyc?.stripeConnectAccountId) {
        ...
        const accountLink = await stripe.accountLinks.create({
          ...
          refresh_url: 'https://entrelles.com/kyc/refresh',
          return_url: 'https://entrelles.com/kyc/success',
...
const createOnboardingLink = async (req, res) => {
    try {
      ...
      const validReturnUrl = returnUrl && returnUrl.startsWith('https://') 
        ? returnUrl 
        : 'https://entrelles.com/kyc/success';
    
      const validRefreshUrl = refreshUrl && refreshUrl.startsWith('https://') 
        ? refreshUrl 
        : 'https://entrelles.com/kyc/refresh';
